...
**（2026-08-10 追記。`adr/0020`、提案中・未承認のドラフト。friction-log FR-013）** 本ADRの記録には
...
再確認されないまま「却下（人間裁定）」という体裁で記録された。この追記は、`architect`（`adr/0020`
起草時）が当初この却下の記録をそのまま引用し、人間の再承認を求める根拠として「人間が過去にこの提案を
明示的に却下した」と誤って記載したことをorchestratorが検知し、friction-log FR-013
