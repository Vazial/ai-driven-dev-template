...
The candidate-card refinement pull request carries ADR-0012, ADR-0013, `candidate-search-browser-interface.yaml` v0.3, and `authentication-browser-interface.yaml` v0.2 under ADR-0035 approval mode (i). The human approved the round-2 design base, the PC layout, the narrow-width direction, the terminology change, and the three header changes across chat reviews on 2026-08-06; the approval act itself is the merge of that pull request.
