...
**デザイナーへの要求（人間から、2026-09-12）**:
- **ワイヤフレームの分け方そのものを人間が決めたい。**勝手に分けない。板を描く前に分け方の案を
  出して裁定を受けること。
- **1枚ずつ順に見られる形にする。**「何枚も長い画面を並べられたらレビューできない」。
  前回の6枚を1つのキャンバスに並べた形は不可。
- **画面のつながり（どこから来て、どこへ戻るか）を必ず含める**（FR-036）。
